...
function BookmarkCtrl(e,o,t,r){e.bookmarks=t.query({},function(o){e.loading=!1,e.updateCategories(),e.bookmarksByCategory=o}),e.bookmarksByCategory=[],e.categories=[],e.search=r,e.loading=!0,e.$on("selectCategory",function(o,t){if(t){for(var r=[],a=0,i=e.bookmarks.length;i>a;a++)e.bookmarks[a].category._id===t._id&&r.push(e.bookmarks[a]);e.bookmarksByCategory=r}else e.bookmarksByCategory=e.bookmarks}),e.updateCategories=function(){for(var o={},t="",r=0,a=e.bookmarks.length;a>r;r++)t=e.bookmarks[r].category._id,o[t]?o[t]++:(o[t]=1,e.categories.push(e.bookmarks[r].category));for(var r=0,a=e.categories.length;a>r;r++)e.categories[r].count=o[e.categories[r]._id]},e.edit=function(o){e.$parent.$broadcast("editBookmark",o)},e["delete"]=function(e){t["delete"]({id:e._id},function(){o.reload()})}}function dvLoading(){var e={restrict:"AE",template:'<div class="loading"><div class="double-bounce1"></div><div class="double-bounce2"></div></div>'};return e}function dvWidgetBody(){var e={requires:"^dvWidget",scope:{loading:"@?",classes:"@?"},transclude:!0,template:'<div class="widget-body" ng-class="classes"><div class="widget-content" ng-transclude></div></div>',restrict:"E"};return e}function dvWidgetFooter(){var e={requires:"^dvWidget",transclude:!0,template:'<div class="widget-footer" ng-transclude></div>',restrict:"E"};return e}function dvWidgetTitle(){var e={requires:"^dvWidget",scope:{title:"@",url:"@",icon:"@"},transclude:!0,template:'<div class="widget-header"><div class="row"><div class="pull-left"><i class="fa" ng-class="icon"></i><a href="{{url}}" target="_blank">{{title}}</a></div><div class="pull-right col-xs-6 col-sm-4" ng-transclude></div></div></div>',restrict:"E"};return e}function dvWidget(){var e={transclude:!0,template:'<div class="widget" ng-transclude></div>',restrict:"EA"};return e}function MasterCtrl(e,o,t){var r=992;e.pageTitle="All",e.search=t,e.setCategory=function(o){angular.isDefined(o)?(e.pageTitle="All / "+o.name,e.$broadcast("selectCategory",o)):(e.pageTitle="All",e.$broadcast("selectCategory"))},e.getWidth=function(){return window.innerWidth},e.$watch(e.getWidth,function(t,a){t>=r?angular.isDefined(o.get("toggle"))?e.toggle=!!o.get("toggle"):e.toggle=!0:e.toggle=!1}),e.toggleSidebar=function(){e.toggle=!e.toggle,o.put("toggle",e.toggle)},window.onresize=function(){e.$apply()}}angular.module("DejaVu",["ui.bootstrap","ui.router","ngCookies","ngResource"]),angular.module("DejaVu").config(["$stateProvider","$urlRouterProvider",function(e,o){o.otherwise("/"),e.state("home",{url:"/",templateUrl:"home/home.html"}).state("bookmarks",{url:"/bookmarks",views:{"":{templateUrl:"dashboard/dashboard.html",controller:"MasterCtrl"},"sidebar@bookmarks":{templateUrl:"dashboard/sidebar.html",controller:"BookmarkCtrl"},"headerbar@bookmarks":{templateUrl:"dashboard/headerbar.html"},"bookmarkList@bookmarks":{templateUrl:"bookmarks/bookmarks.html",controller:"BookmarkCtrl"},"bookmarkForm@bookmarks":{templateUrl:"bookmarks/bookmark-detail.html",controller:"ModalCtrl"}}})}]),angular.module("DejaVu").controller("ModalCtrl",["$scope","$state","$uibModal","categoryService","bookmarkService",function(e,o,t,r,a){e.animationsEnabled=!0,e.categories=r.query(),e.bookmark={},e.$on("editBookmark",function(o,t){e.bookmark=angular.copy(t),e.bookmark.category=t.category._id,e.open()}),e.open=function(r){var i=t.open({animation:e.animationsEnabled,templateUrl:"bookmarkForm.html",controller:"ModalInstanceCtrl",size:r,resolve:{bookmark:function(){return e.bookmark},categories:function(){return e.categories}}});i.result.then(function(t){"undefined"!=typeof t.name&&"undefined"!=typeof t.url&&"undefined"!=typeof t.category&&(t._id?a.update(t,function(){o.reload()}):a.save(t,function(){o.reload()})),e.bookmark={}},function(){e.bookmark={}})},e.toggleAnimation=function(){e.animationsEnabled=!e.animationsEnabled}}]),angular.module("DejaVu").controller("ModalInstanceCtrl",["$scope","$uibModalInstance","bookmark","categories",function(e,o,t,r){e.bookmark=t,e.categories=r,e.getTitle=function(){return 0===Object.keys(t).length&&t.constructor===Object?"New Bookmark":"Edit Bookmark"},e.title=e.getTitle(),e.getLabel=function(){return 0===Object.keys(t).length&&t.constructor===Object?"Add":"Update"},e.label=e.getLabel(),e.ok=function(){o.close(e.bookmark)},e.cancel=function(){o.dismiss()}}]),angular.module("DejaVu").controller("BookmarkCtrl",["$scope","$state","bookmarkService","searchService",BookmarkCtrl]),angular.module("DejaVu").directive("dvLoading",dvLoading),angular.module("DejaVu").directive("dvWidgetBody",dvWidgetBody),angular.module("DejaVu").directive("dvWidgetFooter",dvWidgetFooter),angular.module("DejaVu").directive("dvWidgetHeader",dvWidgetTitle),angular.module("DejaVu").directive("dvWidget",dvWidget),angular.module("DejaVu").controller("MasterCtrl",["$scope","$cookieStore","searchService",MasterCtrl]),angular.module("DejaVu").factory("bookmarkService",["$resource",function(e){return e("https://dejavu-api.herokuapp.com/bookmarks/:id",{id:"@_id"},{update:{method:"PUT"}})}]),angular.module("DejaVu").factory("categoryService",["$resource",function(e){return e("https://dejavu-api.herokuapp.com/categories/:id",{id:"@_id"},{update:{method:"PUT"}})}]),angular.module("DejaVu").factory("searchService",function(){return{input:""}});
angular.module("DejaVu").run(["$templateCache",function(r){r.put("bookmarks/bookmark-detail.html",'<div class="fab" ng-click="open()"><span>+</span></div>\r\n<script type="text/ng-template" id="bookmarkForm.html">\r\n  <div class="modal-header">\r\n    <button type="button" class="close" ng-click="cancel()" aria-label="Close"><span aria-hidden="true">&times;</span></button>\r\n    <h4 class="modal-title"><i class="fa fa-bookmark" aria-hidden="true"></i> {{title}}</h4>\r\n  </div>\r\n  <div class="modal-body">\r\n    <div class="form-group">\r\n      <label class="sr-only" for="bookmark-url">Link</label>\r\n      <div class="input-group">\r\n        <div class="input-group-addon"><i class="fa fa-link" aria-hidden="true"></i></div>\r\n        <input type="url" class="form-control" id="bookmark-url" placeholder="Link" ng-model="bookmark.url">\r\n      </div>\r\n    </div>\r\n    <div class="form-group">\r\n      <label class="sr-only" for="bookmark-name">Name</label>\r\n      <input type="text" class="form-control" id="bookmark-name" placeholder="Name" ng-model="bookmark.name">\r\n    </div>\r\n    <div class="form-group">\r\n      <label for="bookmark-category">Category</label>\r\n      <select class="form-control" id="bookmark-category" ng-model="bookmark.category" ng-options="category._id as category.name for category in categories">\r\n      </select>\r\n    </div>\r\n  </div>\r\n  <div class="modal-footer">\r\n    <button type="button" class="btn btn-primary" ng-click="ok()">{{label}}</button>\r\n    <button type="button" class="btn btn-default" ng-click="cancel()">Cancel</button>\r\n  </div>\r\n</script>'),r.put("bookmarks/bookmarks.html",'<div class="row">\r\n    <dv-loading ng-show="loading"></dv-loading>\r\n    <div ng-hide="loading" class="col-lg-6" ng-repeat="bookmark in bookmarksByCategory | orderBy:\'name\' | filter:{name: search.input}">\r\n    <dv-widget>\r\n      <dv-widget-header icon="{{bookmark.category.icon}}" title="{{bookmark.name}}" url="{{bookmark.url}}">\r\n        <div class="item dropdown" uib-dropdown>\r\n          <a href="#" class="dropdown-toggle" uib-dropdown-toggle>\r\n            <i class="fa fa-ellipsis-h pull-right bookmark-options" aria-hidden="true"></i>\r\n          </a>\r\n          <ul class="dropdown-menu dropdown-menu-right">\r\n            <li class="link">\r\n              <a href="#/bookmarks" ng-click="edit(bookmark)">Edit</a>\r\n            </li>\r\n            <li class="divider"></li>\r\n            <li class="link">\r\n              <a href="#/bookmarks" ng-click="delete(bookmark)">Remove</a>\r\n            </li>\r\n          </ul>\r\n        </div>\r\n      </dv-widget-header>\r\n      <dv-widget-body classes="medium no-padding">\r\n        <img src="img/status.gif" class="widget-snapshot">\r\n      </dv-widget-body>\r\n      <dv-widget-footer>\r\n        <ul class="tags">\r\n          <li><a href="#/bookmarks" class="tag">Tag#1</a><a href="#/bookmarks" class="tag">Tag#2</a></li>\r\n        </ul>\r\n      </dv-widget-footer>\r\n    </dv-widget>\r\n  </div>\r\n</div>'),r.put("dashboard/dashboard.html",'<div id="page-wrapper" ng-class="{\'open\': toggle}" ng-cloak>\r\n  <div ui-view="sidebar"></div>\r\n  <div id="content-wrapper">\r\n    <div class="page-content">\r\n      <div ui-view="headerbar"></div>\r\n      <div ui-view="bookmarkList"></div>\r\n      <div ui-view="bookmarkForm"></div>\r\n    </div>\r\n  </div>\r\n</div>'),r.put("dashboard/headerbar.html",'<div class="row header">\r\n  <div class="col-xs-12">\r\n    <div class="user pull-right">\r\n      <div class="item dropdown" uib-dropdown>\r\n        <a href="#" class="dropdown-toggle" uib-dropdown-toggle>\r\n          <i class="fa fa-user" aria-hidden="true"></i>\r\n        </a>\r\n        <ul class="dropdown-menu dropdown-menu-right">\r\n          <li class="dropdown-header">John Do</li>\r\n          <li class="divider"></li>\r\n          <li class="link"><a href="#">Profile</a></li>\r\n          <li class="divider"></li>\r\n          <li class="link"><a href="#">Logout</a></li>\r\n        </ul>\r\n      </div>\r\n    </div>\r\n      <div class="pull-right search-box">\r\n        <div class="search-container">\r\n          <span class="icon"><i class="fa fa-search"></i></span>\r\n          <input type="search" id="search" placeholder="Search..." ng-model="search.input">\r\n        </div>\r\n      </div>\r\n    <div class="meta">\r\n      <div class="page">{{pageTitle}}</div>\r\n    </div>\r\n  </div>\r\n</div>'),r.put("dashboard/sidebar.html",'<div id="sidebar-wrapper">\r\n  <ul class="sidebar">\r\n    <li class="sidebar-main">\r\n      <a ng-click="toggleSidebar()">\r\n        <img src="img/booklet.png"> Déjà Vu\r\n        <span class="menu-icon glyphicon glyphicon-transfer"></span>\r\n      </a>\r\n    </li>\r\n    <li class="sidebar-title sidebar-form">\r\n      <form class="form-inline">\r\n        <input type="text" placeholder="Add a category..." class="form-control sidebar-input input-sm">\r\n        <i class="btn-icon fa fa-plus-circle fa-2x" aria-hidden="true"></i>\r\n      </form>\r\n    </li>\r\n    <li class="sidebar-list">\r\n      <a href="#/bookmarks" ng-click="setCategory()">All<span class="menu-badge badge">{{bookmarks.length}}</span><span class="menu-icon fa fa-star"></span></a>\r\n    </li>\r\n    <li class="sidebar-title"><span>CATEGORIES</span></li>\r\n    <li class="sidebar-list" ng-repeat="category in categories | orderBy:\'name\'">\r\n      <a href="#/bookmarks" ng-click="setCategory(category)">{{category.name}}<span class="menu-badge badge">{{category.count}}</span><span class="menu-icon fa" ng-class="category.icon"></span></a>\r\n    </li>\r\n  </ul>\r\n  <div class="sidebar-footer">\r\n    <div class="col-xs-4">\r\n      <a href="https://github.com/guitul/dejavu-web" target="_blank">Github</a>\r\n    </div>\r\n    <div class="col-xs-4">\r\n      <a href="https://github.com/guitul/dejavu-web/blob/master/README.md" target="_blank">About</a>\r\n    </div>\r\n    <div class="col-xs-4">\r\n      <a href="https://www.coursera.org/learn/web-development-project/home/welcome" target="_blank">Coursera</a>\r\n    </div>\r\n  </div>\r\n</div>'),r.put("home/home.html",'<div class="welcome">\r\n  <div class="col-xs-12 text-center welcome-text">\r\n    <h1 id="app">Déjà Vu</h1>\r\n    <h3 id="motto">Your Bookmarks in the Cloud</h3>\r\n    <ul class="list-inline">\r\n      <li><a href="#/bookmarks" class="btn btn-lg btn-welcome btn-login">Log In</a>\r\n      </li>\r\n      <li><a href="#/bookmarks" class="btn btn-lg btn-welcome btn-register">Register</a>\r\n      </li>\r\n    </ul>\r\n  </div>\r\n</div>')}]);